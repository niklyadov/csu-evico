...
public class EventReviewService
{
    ...
    public async Task<Result<EventReviewRecord>> Add(EventReviewRecord eventReviewRecord)
    {
        ...
        {
            return await _eventReviewQueryBuilder.AddAsync(eventReviewRecord);
        });
    }
    ...
    public Result CanUpdate(EventReviewRecord eventReviewRecord, ProfileRecord profileRecord)
    {
    ...
    public Result CanDelete(EventReviewRecord eventReviewRecord, ProfileRecord profileRecord)
    {
